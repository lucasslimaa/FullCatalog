...
namespace FullCatalog.App.Extensions
{
    ...
    public class ExcludeElementByClaimTagHelper : TagHelper
    {
        private readonly IHttpContextAccessor _httpContextAccessor;

        public ExcludeElementByClaimTagHelper(IHttpContextAccessor httpContextAccessor)
        {
    ...
    public class DisableLinkByClaimTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.Add(new TagHelperAttribute("title", "You dont have permission"));
        }
    }

    [HtmlTargetElement("*", Attributes = "supress-by-action")]
    public class ExcludeElementByActionTagHelper : TagHelper
    {
        private readonly IHttpContextAccessor _contextAccessor;

        public ExcludeElementByActionTagHelper(IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
        }
